...
const files = [
    "src/components/account/AuthModal.jsx",
    "src/pages/AccountTrustPage.jsx",
...
if (missing.length) {
    console.error(`Thiếu 2FA contract: ${missing.join(", ")}`);
    process.exit(1);
}
console.log("Two-factor authentication contract OK");
