                ...
                >
                    <BaseFormGrid>
                        ...
                        <FormField label="Trò chơi" required>
                            ...
                            >
                                <option value="ninja_school">Ninja School</option>
                        ...
                        <FormField label="Loại sản phẩm" required>
                            ...
                            >
                                <option value="game_account">Tài khoản trò chơi</option>
                                <option value="item">Vật phẩm</option>
                                <option value="currency">Tiền tệ trong game</option>
                    ...
                    <>
                            ...
                            <BaseFormGrid>
                                ...
                                <FormField label="Tiền cọc thuê">
                                    <MoneyInput
                                        ...
                                        min={0}
                                        onChange={(value) =>
                                            update('rental_deposit_amount', value)
                                        }
                                    />
                                </FormField>
                            </BaseFormGrid>
                        ...
                        >
                            <div className="rental-rate-editor__rows">
                                {data.rental_rates.map((rate, index) => (
                                    <div className="rental-rate-row" key={index}>
                                        ...
                                        <GamingButton
                                            ...
                                            disabled={data.rental_rates.length === 1}
                                        >
                                            Xóa
                                        </GamingButton>
                                    </div>
