...
export default function WalletTransactionsPage() {
    ...
    const metrics = [
        ...
        },
        {
            ...
            description: "Đang bảo đảm cho giao dịch",
            tone: "warning",
        },
        {
            label: "Nạp tiền chờ xác nhận",
            value: formatMoney(wallet.pending_deposit_balance || 0),
            description: "Chứng từ đang chờ đối soát",
            tone: "warning",
        },
        {
            label: "Tổng số dư trong ví",
    ...
    return (
        <PageShell
            ...
            description="Theo dõi số dư trước, biến động và số dư sau của từng nghiệp vụ."
            loading={loading}
        ...
        >
            <PageStack>
                ...
                <PageSection
                    ...
                    description="Các yêu cầu nạp tiền đang chờ được tách riêng khỏi số dư khả dụng."
                >
                    <ResponsiveDataTable
                        caption="Lịch sử biến động số dư"
                        columns={columns}
                        rows={rows}
                        rowKey="id"
                        minWidth={940}
