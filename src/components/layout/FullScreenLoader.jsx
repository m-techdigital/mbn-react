...
const enabled = String(import.meta.env.VITE_FULL_SCREEN_LOADING ?? 'true').toLowerCase() !== 'false';
...
export default function FullScreenLoader() {
  ...
  const begin = useCallback((nextLabel = 'Đang chuyển trang') => {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      window.removeEventListener('mbn:navigation-start', onNavigationStart);
      window.removeEventListener('popstate', onPopState);
      window.removeEventListener('mbn:navigation-settled', onNavigationSettled);
    };
  ...
  return (
    <div className={`fullscreen-loader is-${phase}`} role="status" aria-live="polite" aria-label={label}>
      ...
      <div className="fullscreen-loader__content">
        ...
        <div className="fullscreen-loader__bar" aria-hidden="true"><span /></div>
        <div className="fullscreen-loader__dots" aria-hidden="true"><i /><i /><i /></div>
      </div>
    </div>
  );
}
