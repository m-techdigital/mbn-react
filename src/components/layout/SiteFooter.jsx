            ...
            <div className="site-footer__inner">
                <section className="site-footer__brand">
                    <div className="site-footer__identity">
                        ...
                        />
                        <p>
                            Nền tảng hỗ trợ mua, thuê và bàn giao tài khoản trò
                            chơi theo quy trình có theo dõi.
                        </p>
                    </div>
                    <div className="site-footer__assurance">
                        <strong>Giao dịch đúng quy trình</strong>
                        <span>
                            Thanh toán, hồ sơ và hỗ trợ đều được theo dõi trong
                            tài khoản.
                        </span>
                    </div>
