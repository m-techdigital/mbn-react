...
export default function AppLayout() {
  ...
  const openAccount = () => isAuthenticated ? navigate('/account/profile') : openAuth('login');
  ...
  return (
    <div className="app theme-dark">
      <a className="mbn-skip-link" href="#main-content">Bỏ qua điều hướng</a>
      <RouteMetadata />
      <ToastCenter />
      <RouteProgress />
      <FullScreenLoader />
      ...
      <div className={`site-frame ${isAccountWorkspace ? 'site-frame--account' : 'site-frame--public'}`}>
