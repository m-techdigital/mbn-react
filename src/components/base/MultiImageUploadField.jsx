    ...
    return (
        <section className="mbn-multi-upload">
            <header className="mbn-multi-upload__head">
                ...
                <label
                    className={`mbn-multi-upload__button ${loading ? "is-loading" : ""}`}
                >
                    <input
                        type="file"
            ...
            {images.length ? (
                <div className="mbn-multi-upload__grid">
                    {images.map((url, index) => (
                        <figure key={`${url}-${index}`}>
                            ...
                            {index === 0 ? <small>Ảnh đại diện</small> : null}
                        </figure>
                    ))}
                </div>
            ) : (
                <p className="mbn-multi-upload__empty">
