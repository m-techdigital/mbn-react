      ...
      <div className="page-panel">
        {(title || description || back || hasTools) ? (
          <header className="mbn-page-header">
            {back ? (
              <button type="button" className="mbn-page-header__icon mbn-page-header__back" onClick={back} aria-label="Quay lại">
                <ArrowLeftOutlined />
              </button>
            ) : null}
            ...
            {hasTools ? (
              <div className="mbn-page-header__tools">
                {actions ? <div className="mbn-page-header__actions">{actions}</div> : null}
                {onReload ? (
                  <button type="button" className="mbn-page-header__icon" onClick={onReload} aria-label="Tải lại" disabled={loading}>
                    <ReloadOutlined className={loading ? 'is-spinning' : ''} />
                  </button>
                ) : null}
              </div>
            ) : null}
