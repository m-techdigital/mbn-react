...
const VALUE_LABELS = {
    ...
    week: "tuần",
    month: "tháng",
    available: "Khoản khả dụng",
    held_balance: "Khoản tạm giữ",
    ...
    withdrawal_reserved: "Giữ tiền chờ rút",
    withdrawal_released: "Hoàn tiền yêu cầu rút",
    withdrawal_paid: "Đã chi trả tiền rút",
    settlement_gross_debit: "Quyết toán tổng tiền tạm giữ",
    settlement_net_credit: "Tiền ròng người bán nhận",
...
export function statusLabel(value, fallback = "Đang xử lý", context = "") {
    return (
        CONTEXT_STATUS_LABELS[context]?.[value] ||
        STATUS_LABELS[value] ||
        VALUE_LABELS[value] ||
        fallback
    );
